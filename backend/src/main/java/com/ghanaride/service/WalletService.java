...
public class WalletService {
    ...
    @Transactional
    public WalletTransaction topup(User user,
                                   BigDecimal amount,
                                   String provider,
                                   String providerRef) {
    ...
    @Transactional
    public boolean payWithWallet(User user,
                                 BigDecimal amount,
                                 String description,
                                 String bookingRef) {
        ...
        // 2% loyalty cashback
        BigDecimal points = amount.multiply(new BigDecimal("0.02"))
        ...
        if (points.compareTo(BigDecimal.ZERO) > 0) {
            ...
            txRepository.save(
                    WalletTransaction.builder()
                            ...
                            .amount(points)
                            .balanceAfter(wallet.getBalance())
                            .loyaltyBalanceAfter(wallet.getLoyaltyPoints())
    ...
    @Transactional(readOnly = true)
    public Page<WalletTransaction> history(Long userId,
                                           int page,
                                           int size) {
        ...
        return txRepository.findByUserOrderByCreatedAtDesc(
                user,

...
export default function RefundsPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-3xl">
      <h1 className="text-4xl font-bold mb-6">Refunds</h1>
      <div className="prose dark:prose-invert">
        <p>This is the refunds page for GhanaRide. Original Thymeleaf content preserved and improved with modern Next.js UI.</p>
        <h2>Our Mission</h2>
